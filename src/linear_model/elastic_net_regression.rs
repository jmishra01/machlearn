...
/// [`crate::LassoRegression`]'s objective; `l1_ratio = 0.0` reduces to
/// [`crate::RidgeRegression`]'s objective, though
/// [`crate::RidgeRegression`]'s closed-form solver is exact and preferred
/// for pure L2 regularization. Unlike [`crate::LinearRegression`] and
