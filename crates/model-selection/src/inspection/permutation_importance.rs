...
use crate::model_selection::ScoreDirection;
use machlearn_core::core::{Dataset, MlError, Predict, Result};
...
/// moves for `scorer`, exactly as in [`crate::model_selection::grid_search`]: pass
