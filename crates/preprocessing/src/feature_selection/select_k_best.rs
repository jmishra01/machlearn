...
/// [`crate::feature_selection::f_classif`] or [`crate::feature_selection::f_regression`].
///
/// Unlike [`crate::feature_selection::VarianceThreshold`], scoring looks at the relationship
