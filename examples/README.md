...
| `arrow_dataset`                  | Loading a dataset from an Arrow `RecordBatch`, imputing nulls                                                | `cargo run --example arrow_dataset --features arrow`                 |
| `iris_classification`            | Full worked classification example on real Iris flower data (see the [project page](https://jmishra01.github.io/machlearn/))    | `cargo run --example iris_classification --features csv`             |
| `mtcars_regression`              | Full worked regression example on real 1974 car road-test data (see the [project page](https://jmishra01.github.io/machlearn/)) | `cargo run --example mtcars_regression --features csv`               |
